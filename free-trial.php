...
<section>
    <div class="container">
        <h2 class="mt-4 text-muted">Free Trial</h2>
            <p class="pb-3">
                <strong class="main_color fs_20">Send us your free trial request today.</strong>
                <br>
              <span class="font-weight-normal">We ensure you 3 hours turnaround time maximum for free trial images. We never use client's image for personal or business purpose.
            </p>
        </div>
    <div class="container">
        <div class="row">
            <div class="col-md-8 mb-4">
                <form id="uploadForm" action="upload_plugin/upload_free.php" method="POST" enctype="multipart/form-data" name="free_trial_form">
                    ...
                    <input type="hidden" name="freetrial" value="1">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="email" class="form-control" id="fld_email" name="fld_email" placeholder="Enter Email" required="">
                        </div>
                    </div>
                    <div class="form-group row">
